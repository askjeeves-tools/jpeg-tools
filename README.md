...
End-to-end tests under `tests/e2e/` use local helpers in `tests/e2e/helpers.ts` and fixtures generated by `scripts/generate-test-fixtures.mjs` before each run. No external `@askjeeves/test-e2e` package is required.
