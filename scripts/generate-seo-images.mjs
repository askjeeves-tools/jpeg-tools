...
<svg width="${width}" height="${height}" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="50%" y="42%" text-anchor="middle" fill="#ffffff" font-family="Segoe UI, Arial, sans-serif" font-size="${titleSize}" font-weight="700">Free Secure JPEG Converter</text>
...
copyFileSync(appleTouchIcon, join(publicDir, "apple-touch-icon.png"));
copyFileSync(favicon32, join(uiAssetsDir, "favicon-32x32.png"));
copyFileSync(favicon16, join(uiAssetsDir, "favicon-16x16.png"));

await sharp(favicon32).png().toFile(join(publicDir, "favicon.ico"));

console.log(
	"Generated public/og.png, apple-touch-icon.png, favicon.ico, and synced UI favicon assets",
);
